...
for query in all_info_create_test_cases[:1]:
    updated_query, request_type, num_attempts = follow_up_iterative([query], 3, prompt_template=FOLLOW_UP_COT_PROMPT_TEMPLATE)
    ...
    upd_output, code_exec_status, returned_value = self_heal(output, num_retries=2)
